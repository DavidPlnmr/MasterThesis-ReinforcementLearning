...
La campagne cible au minimum \textbf{150 essais} par combinaison algorithme/environnement.
...
algorithme, leur rôle et les plages de recherche utilisées. Il est important de noter que pour l'ensemble des expériences, la politique neuronale employée repose sur des Perceptrons Multicouches (MLP, illustré par \texttt{MlpPolicy} dans l'écosystème Stable-Baselines3). L'état de l'environnement \textit{LunarLander} étant un simple vecteur de 8 dimensions, l'utilisation de réseaux convolutifs n'est donc pas pertinente dans ce contexte.
