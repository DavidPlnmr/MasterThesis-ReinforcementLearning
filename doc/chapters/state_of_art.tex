...
Le RL se caractérise principalement par l'absence d'expert superviseur (aucun label ne vient indiquer la "bonne" action à prendre, seul le signal de récompense sert de retour), des \textit{feedbacks} souvent différés soulignant le problème de l'assignation de crédit\footnote{Credit Assignment Problem}, et des données fortement corrélées temporellement (elles ne sont pas indépendantes et identiquement distribuées, ou i.i.d.).
