...
\usepackage[backend=biber,style=iso-authoryear,urldate=short, maxcitenames=2, mincitenames=1, uniquelist=true, autolang=none,]{biblatex}
...
apprentissage par renforcement, sparse reward, reward shaping, curriculum learning, reward hacking, optimisation d'hyperparamètres, Gymnasium, DQN, PPO, SAC, self-play, Rocket League, RLGym
